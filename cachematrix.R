...
##
##
## The 1st function makeCacheMatrx() simply caches a matrix, retrieves the cached matrix, 
...
##  -return the cached matrix inverse ( mat2$getSolve() )
##
...
## If so, the user is prompted that the inverse exists and the inverse matrix is 
